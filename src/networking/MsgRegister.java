 ...
 * This message contains user data: player name, email address, password
 * These values are validated and processed by the server
 * As soon as the server knows whether the new account was created successfully or not
...
public class MsgRegister extends GenericMessage {
	...
	// Constructor for creating message with necessary payload
